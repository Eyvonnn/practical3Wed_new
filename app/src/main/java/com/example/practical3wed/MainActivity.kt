package com.example.practical3wed
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListener(){
        ...
        val rootConstrainLayout= findViewById<View>(R.id.constarint_layout)

        val clickableList: List<View> = listOf(boxOneText,boxTwoText,boxThreeText,boxFourText,boxFiveText,rootConstrainLayout,redButton,greenButton,yellowButton)
